            ...
            <div class="tab-content" id="myTabContent">
                                    ...
                                    <div id="collapse{{$season->id}}" class="collapse" aria-labelledby="heading{{$season->id}}" data-parent="#accordionExample">
                                        <div class="card-body">
                                            @foreach($season->showVideo as $videos)
                                                <a href="{{route('watch.show', [$show->slug, $videos->video->id])}}" class="d-block">
                                                    <div class="row">
                                                        <div class="col-md-1">
                                                            <div class="img-video">
                ...
                <div class="tab-pane fade" id="videoContent" role="tabpanel" aria-labelledby="videoContent-tab">
                    ...
                    @if(!isset($video))
                        ...
                        @if($show->seasons[0]->showVideo[0]->video->audios != null && $show->seasons[0]->showVideo[0]->video->audios != '' && count($show->seasons[0]->showVideo[0]->video->audios) > 0)
                            ...
                            @endforeach
                        @endif
                        @if($show->seasons[0]->showVideo[0]->video->documents != null && $show->seasons[0]->showVideo[0]->video->documents != '' && count($show->seasons[0]->showVideo[0]->video->documents) > 0)
                ...
                <div class="tab-pane fade" id="comments" role="tabpanel" aria-labelledby="comments-tab">
                    ...
                    @else
                        <div class="content-comments">
                            ...
                            <div class="comments">
                                @foreach($show->seasons[0]->showVideo[0]->video->comments as $comment)
                                    <div class="media" data-comment-id="{{$comment->id}}">
                                        @if($comment->user->avatar != null || $comment->user->avatar != '')
                                            <img src="{{asset('uploads/avatars/' . $comment->user->avatar)}}" class="mr-3" alt="{{$comment->user->name}}">
                                        @else
                            ...
                            <div class="add-comment">
                                ...
                                <div class="body">
                                    <form id="formComment" method="post" action="{{route('add.comment')}}">
                                        @csrf
                                        <input type="hidden" name="video_id" value="{{$show->seasons[0]->showVideo[0]->video->id}}">
                                        <textarea name="comment" id="textComment" class="form-control"></textarea>
                                        <button type="submit" id="addComment" class="btn btn-danger">Comment</button>
                                    </form>
                                </div>
