                ...
                <div class="col-sm-12">
                    <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form action="{{route('admin.document.story')}}" method="post" class="form-info-document">
                                        @csrf
                                ...
                                <div class="col-lg-6">
                                    <form action="{{route('admin.document.upload.document')}}" method="post" enctype="multipart/form-data" id="uploadDocument">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <button type="submit" class="btn btn-block btn-primary btn-submit">Upload Document</button>
                                        </div>
                ...
                if($('#uploadFile').val())
                {
                    ...
                    $(this).ajaxSubmit({
                        ...
                        complete: function(xhr){
                            ...
                            $('.form-info-document').append("<input type='hidden' name='document_name' value='"+xhr.responseJSON.documentName+"'>");
                            $('#loader-icon').hide();
                            $('#loader-icon2').show();
                            $('#targetLayer').show();
