                ...
                <div class="col-sm-12">
                    <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form action="{{route('admin.audio.update')}}" method="post" class="form-info-audio">
                                        @csrf
                                        <input type="hidden" name="audio_name" value="{{$audio->audio_name}}" id="audio_name">
                                        <input type="hidden" name="id" value="{{$audio->id}}">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Name" name="name" value="{{old('name', $audio->name)}}">
                ...
                if($('#uploadFile').val())
                {
                    ...
                    $(this).ajaxSubmit({
                        ...
                        complete: function(xhr){
                            ...
                            $('#audio_name').attr('value', xhr.responseJSON.audioName);
                            $('#loader-icon').hide();
                            $('#loader-icon2').show();
                            $('#targetLayer').show();
