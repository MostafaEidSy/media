                                ...
                                <div class="col-lg-12">
                                    <form action="{{route('admin.page.update', $page->id)}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Name" name="name" required="required" value="{{old('name', $page->name)}}">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="slug" id="slug" class="form-control" placeholder="Slug" required="required" value="{{old('slug', $page->slug)}}">
                                        ...
                                        <div class="form-group">
                                            <select name="in_footer" class="selectpicker" title="Show Place" required="required">
                                                <option value="0" @if(old('in_footer', $page->in_footer) == 0) selected @endif>Not Showing Off</option>
                                                <option value="1" @if(old('in_footer', $page->in_footer) == 1) selected @endif>Footer 1</option>
                                                <option value="2" @if(old('in_footer', $page->in_footer) == 2) selected @endif>Footer 2</option>
                                                <option value="3" @if(old('in_footer', $page->in_footer) == 3) selected @endif>Footer 3</option>
                                            </select>
